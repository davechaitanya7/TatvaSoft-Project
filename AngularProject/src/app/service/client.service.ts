...
export class ClientService {
  ...
  MissionList(userId:any):Observable<Mission[]>{
    return this.http.get<Mission[]>(`${this.apiUrl}/ClientSideMission/ClientSideMissionList/${userId}`);
  }
  ...
  ApplyMission(data:any){debugger;
     return this.http.post(`${this.apiUrl}/ClientSideMission/ApplyMission`,data);
  }
